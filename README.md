...
- Add support for utilizing the D-110 PCM samples ROM. The D-110 and MT-32 are very similar synth-wise as they are both LA synthesizers, but the D-110 has a very different PCM sample set. It would be nice to have the option if one has the ROM.
